const VideoTitle = ({ title, overview }) => {
  return (
    <div className=" aspect-video pt-50%] md:pt-[20%] px-12 absolute bg-gradient-to-r from-black text-white">
    <h1 className="text-2xl md:text-5xl py-3 md:py-3 font-bold">{title}</h1>
